...
},{"./bundle-url":"../../AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"node_modules/swiper/swiper-bundle.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/smoothscroll-polyfill/dist/smoothscroll.js":[function(require,module,exports) {
...
window.addEventListener("DOMContentLoaded", function (event) {
  ...
  var target = document.querySelector("#colophon");
  ...
  if (coursesSection) {
    var nodes = [].slice.call(coursesSection.querySelectorAll("li"), 0);
    var directions = {
      0: "top",
      1: "right",
      2: "bottom",
  ...
  if (applyButton && formModal) {
    applyButton.forEach(function (button) {
  ...
  if (formModal) {
    formModal.addEventListener("click", function (e) {
      e.target === formModal.querySelector("#closeFormModal") || e.target === formModal.querySelector("#closeFormModal svg") || e.target === formModal.querySelector("#closeFormModal path") ? closeModal() : "";
    });
  }
  ...
  var ajaxLoader = status.querySelector("#ajax-loader");
  var courseCheckboxes = document.querySelectorAll(".course-type input");
  courseCheckboxes.forEach(function (checkbox) {
    checkbox.addEventListener("change", function () {
      this.checked ? this.value = true : this.value = false;
    });
  });
  var formAcceptanceCheckbox = document.querySelectorAll(".acceptance-checkbox"); // if (formAcceptanceCheckbox) {
  ...
  var dataProtectionTrigger = document.querySelector(".data-protection__title");
  var dataProtectionExpandIcon = document.querySelector(".data-protection__expand");
  var dataProtectionContent = document.querySelector(".data-protection__content");
  var modalContent = document.querySelector(".modal-content");
  dataProtectionTrigger.addEventListener("click", function (e) {
  ...
  function ajax(method, url, data, success, error) {
    ...
    xhr.onreadystatechange = function () {
      ...
      if (xhr.status === 200) {
        ...
        window.location.href = "".concat(window.location.href, "thank-you");
      } else {
...
},{"swiper":"node_modules/swiper/swiper.esm.js","swiper/swiper-bundle.css":"node_modules/swiper/swiper-bundle.css","swiper/core":"node_modules/swiper/swiper.esm.js","smoothscroll-polyfill":"node_modules/smoothscroll-polyfill/dist/smoothscroll.js"}],"../../AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/js/index.js"], null)
