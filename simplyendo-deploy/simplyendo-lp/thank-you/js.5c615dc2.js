...
window.addEventListener("DOMContentLoaded", function (event) {
  ...
  var formAcceptanceCheckbox = document.querySelectorAll(".acceptance-checkbox");

  if (formAcceptanceCheckbox) {
    formAcceptanceCheckbox.forEach(function (checkbox) {
      checkbox.addEventListener("click", function (e) {
        var submitButton = this.closest("FORM").querySelector("button");
